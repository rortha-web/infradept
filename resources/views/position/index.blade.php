  ...
  <div class="col-xs-10">
    <div class="box box-primary">
      <div class="box-header with-border">
        <a href="{{ route('position.create') }}" class="btn btn-primary btn-xs"> New Position </a>
        <div class="box-tools">
      ...
      <!-- /.box-header -->
      <div class="box-body">
        <table id="tablecheckallposition" class="table table-bordered table-hover text-center">
          <thead>
            <tr>
