  ...
  <div class="col-xs-10">
    <div class="box box-primary">
      <div class="box-header with-border">
        <a href="{{ route('brand-model.create') }}" class="btn btn-primary btn-xs"> New Brand-Model </a>
        <div class="box-tools">
      ...
      <!-- /.box-header -->
      <div class="box-body">
        <table id="tablecheckallbrand" class="table table-bordered table-hover text-center">
          <thead>
            <tr>
          ...
          <tbody>
            @foreach($brands as $key => $brn)
            <tr>
              <td>{{ ++$key }}</td>
              <td>{{ $brn -> name}}</td>
              <td>{{ optional ($brn -> category) -> name }}</td>
              <td>{{ $brn -> description }}</td>
              <td>{{ $brn -> created_at }}</td>
              <td>
